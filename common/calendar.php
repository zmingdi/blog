...
*/
		...
		<td><a href=\"javascript:void(0);\" onclick=\"sendinfo('#','calendar');\"> &laquo; </a>$n_year2<a href=\"javascript:void(0);\" onclick=\"sendinfo('#','calendar');\"> &raquo; </a></td>
		<td><a href=\"javascript:void(0);\" onclick=\"sendinfo('#','calendar');\"> &laquo; </a>$n_month<a href=\"javascript:void(0);\" onclick=\"sendinfo('#','calendar');\"> &raquo; </a></td>
		</tr></table>
		...
		for ($i = 1;$i <= 6;$i++) {
           ...
           */
          if ($n_time == $time) {
						$calendar .= '<td class="day" style="background-color:yellow">'. $t .'</td>';
					} else {
            $calendar.= '<td>'. $r .'</td>';
          }
